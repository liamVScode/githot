<%-- 
    Document   : index.jsp
    Created on : Apr 17, 2023, 3:24:52 PM
    Author     : Chinhdd3
--%>
...
<html lang="en">
    <head>
        ...
        <jsp:useBean id="rtype" class="dao.RoomTypeDAO" scope="request"></jsp:useBean>
    </head>
    <body>
        ...
        <section class="accomodation_area section_gap">
            <div class="container">
                ...
                <div class="row mb_30">
                    <c:forEach items="${rtype.listRoomType}" var="i">
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            ...
                            <a href="#"><h4 class="sec_h4">${i.name}</h4></a>
                            <h5>${i.defaultPrice}<small>/night</small></h5>
                        </div>
                    </div>
                    </c:forEach>
                </div>
